...
//1.accounts es un array de diferentes adresses generadas por ganache
module.exports = async function(deployer, _network, accounts) {
  //2.Simulamos los traders
  ...
  //3.Añadimos el código para añadir balance a las carteras del dex
  ...
  const seedTokenBalance = async (token, trader) => {
    ...
    //4. En la Mainnet, necesitamos que el trader aprueve que se puedan utilizar sus tokens
    // en el exchange con el consentimiento del trader, finalmente se depositarán del trader al smart contract
...
//Función de utilidad para incrementar en X segundos el tiempo
//entre diferentes operaciones realizadas en la blockchain
 ...
 //Creamos los trades haciendo que coincidan las compras con las ventas y viceversa
  ...
  //Creamos ordenes de compra/venta a X precio sin ser el precio de mercado
  await Promise.all([
